// upload.js - Frontend JavaScript for handling question set uploads
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    uploadForm.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            // Send to server
            // Get facultyId from session
            const facultySession = sessionStorage.getItem('loggedInFaculty');
            let facultyId = null;
            if (facultySession) {
                try {
                    facultyId = JSON.parse(facultySession).id;
                } catch (e) { }
            }
